            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Transaksi Admin</h4>
                </div>
            ...
            <div class="row">
                ...
                <?php 
                    ...
                    foreach ($transaksi->result() as $key) {
                        ...
                        if($key->status_pesanan=='2'){

                            $info = "<br>User telah upload</b> <a href='".base_url()."uploads/$key->bukti_bayar' target='blank'>Bukti bayar anda</a>";
                            $btn = "<a href='#' onclick='set_status_trx($key->id_trx,3);return false;' class='btn btn-xs btn-success  btn-block' >Terima</a>";
                            $btn.= "<a href='#' onclick='set_status_trx($key->id_trx,5);return false;' class='btn btn-xs btn-danger  btn-block' >Tolak</a>";
                            ...
                            <tr>
                                <td>$no</td>
                                 <td>   
                                    ...
                                    <br><button class='btn btn-xs btn-info ' onclick='edit($key->id_iklan,2)'>Detail</button>
                                </td>   
                                
                                <td>$key->nama_pemilik - $key->perusahaan_pemilik - $key->alamat_pemilik</td>
...
function set_status_trx(id,code)
{
    ...
    {
        $.post("<?php echo base_url()?>index.php/admin/iklan/set_status_trx",{id:id,code:code},function(){
            eksekusi_controller('<?php echo base_url()?>index.php/admin/iklan/transaksi');
        })      
    }
